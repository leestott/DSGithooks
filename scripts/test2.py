...
# 
# Since its first release in 1991, Python has risen to become not just a popular general-purpose programming language, but a preeminent computer language for data science. This manual is designed to accompany the Microsoft Reactors introduction to data science course, and it will use Python as the primary means of illustrating data-science tools and resources in the cloud. For students unfamiliar with Python (or programming more generally), this course also includes a quick introduction to Python.
# 
